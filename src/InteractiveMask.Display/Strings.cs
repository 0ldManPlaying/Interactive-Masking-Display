...
public sealed class StringsTable
{
    ...
    public static readonly StringsTable De = new()
    {
        ...
        PrivacyCardSessionPin     = "Sitzungs-PIN für Pflegekräfte",
        ...
        PrivacyModeOversightLabel = "Standardansicht (klassische Pflege)",
        PrivacyModeOversightHelp  = "Die Kacheln starten sichtbar. Die Pflegekraft tippt auf eine Kachel, um die Privatsphäre zu schützen, wenn Pflege geleistet wird. Ein Auto-Aus-Timer sorgt dafür, dass eine Maske nicht versehentlich aktiv bleibt.",
        PrivacyModePrivacyLabel   = "Standard-Privat",
        PrivacyModePrivacyHelp    = "Die Kacheln starten unscharf. Die Pflegekraft tippt, um sie zur Verifizierung kurz aufzudecken. Ein Auto-Rollback-Timer bringt die Kachel automatisch wieder in den unscharfen Zustand. Geeignet für Büroräume, Empfangsbereiche oder Standorte mit strengeren Datenschutzvorgaben.",
        ...
        AdminCardIdentity         = "Identität der Pflegekräfte",
        AdminIdentityDescription  = "Wenn aktiviert, fordert das System bei jeder Aufdeckung eine Windows-Anmeldung (LogonUser) anstelle einer gemeinsamen Sitzungs-PIN. Das Audit-Protokoll erfasst den Benutzernamen der Person, die die Maske deaktiviert hat — sinnvoll für die Nachvollziehbarkeit in der Pflege.",
        AdminDomainLabel          = "Standarddomäne (optional)",
        AdminDomainHint           = "Leer lassen, um die aktuelle Maschine / den Domain Controller zu verwenden. Pflegekräfte können auch DOMAIN\\Benutzer oder benutzer@domain eingeben.",
        AdminCardKiosk            = "Kiosk-Modus",
        ...
        AdminCardHelp             = "Hilfe",
        AdminHelpDescription      = "Öffnet das integrierte Handbuch für Pflegekräfte. Hilfreich beim ersten Einsatz oder bei der Schulung neuer Kollegen.",
        ...
        MassUnmaskConfirmTitle    = "Privatsphäre aller Bewohner aufheben?",
    ...
    public static readonly StringsTable Fr = new()
    {
        ...
        PrivacyCardSessionPin     = "PIN de session pour les soignants",
        ...
        PrivacyModeOversightLabel = "Vue par défaut (soins classiques)",
        PrivacyModeOversightHelp  = "Les tuiles démarrent visibles. Le soignant tape sur une tuile pour appliquer la confidentialité lors de la prestation de soins. Un minuteur d'auto-désactivation garantit qu'un masque ne reste pas en place par accident.",
        PrivacyModePrivacyLabel   = "Confidentialité par défaut",
        PrivacyModePrivacyHelp    = "Les tuiles démarrent floutées. Le soignant tape pour révéler brièvement à des fins de vérification. Un minuteur d'auto-rollback ramène la tuile au flou. Convient aux espaces de bureau, aux réceptions ou aux sites avec des paramètres de confidentialité plus stricts.",
        ...
        AdminCardIdentity         = "Identité des soignants",
        AdminIdentityDescription  = "Lorsqu'il est activé, le système demande des informations d'identification Windows (LogonUser) à chaque révélation au lieu d'un PIN de session partagé. Le journal d'audit enregistre le nom d'utilisateur de la personne qui a désactivé le masque — utile pour la responsabilité dans les soins de santé.",
        AdminDomainLabel          = "Domaine par défaut (facultatif)",
        AdminDomainHint           = "Laissez vide pour utiliser la machine actuelle / le contrôleur de domaine. Les soignants peuvent également saisir DOMAINE\\utilisateur ou utilisateur@domaine.",
        ...
        AdminCardHelp             = "Aide",
        AdminHelpDescription      = "Ouvrez le manuel intégré pour les soignants. Utile lors de la première utilisation ou pour former de nouveaux collègues.",
        ...
        MassUnmaskConfirmTitle    = "Lever la confidentialité de tous les résidents ?",
    ...
    public static readonly StringsTable Es = new()
    {
        ...
        PrivacyCardSessionPin     = "PIN de sesión para cuidadores",
        ...
        PrivacyModeOversightLabel = "Vista predeterminada (cuidado clásico)",
        PrivacyModeOversightHelp  = "Los mosaicos comienzan visibles. El cuidador toca un mosaico para aplicar privacidad al prestar atención. Un temporizador de auto-desactivación se asegura de que una máscara no quede activa por accidente.",
        PrivacyModePrivacyLabel   = "Privacidad predeterminada",
        PrivacyModePrivacyHelp    = "Los mosaicos comienzan difuminados. El cuidador toca para revelar brevemente para verificación. Un temporizador de auto-restauración devuelve el mosaico a difuminado. Adecuado para oficinas, recepciones o sitios con configuraciones de privacidad más estrictas.",
        ...
        AdminCardIdentity         = "Identidad de cuidadores",
        AdminIdentityDescription  = "Cuando está habilitado, el sistema solicita credenciales de Windows (LogonUser) en cada revelación en lugar de un PIN de sesión compartido. El registro de auditoría registra el nombre de usuario de quien desactivó la máscara — útil para la rendición de cuentas en el cuidado de la salud.",
        AdminDomainLabel          = "Dominio predeterminado (opcional)",
        AdminDomainHint           = "Déjelo vacío para usar la máquina actual / controlador de dominio. Los cuidadores también pueden escribir DOMINIO\\usuario o usuario@dominio.",
        ...
        AdminCardHelp             = "Ayuda",
        AdminHelpDescription      = "Abra el manual integrado para cuidadores. Útil al usar el sistema por primera vez o al formar a nuevos compañeros.",
        ...
        MassUnmaskConfirmTitle    = "¿Levantar la privacidad de todos los residentes?",
